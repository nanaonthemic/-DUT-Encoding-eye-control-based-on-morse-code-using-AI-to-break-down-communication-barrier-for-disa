	...
	while True:
		...
		for rect in rects:
			...
			cv2.putText(frame, "EAR: {:.2f}".format(eye_ar), (300, 30),
				cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 96, 255), 2)
			cv2.putText(frame, "{}".format(morse_char), (50, 200),
				cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 96, 255), 2)
			cv2.putText(frame, "{}".format(morse_code.from_morse(total_morse)), (50, 250),
				cv2.FONT_HERSHEY_SIMPLEX, 1.2, (152, 251, 152), 2)
